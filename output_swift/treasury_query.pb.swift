...
struct Rizonworld_Rizon_Treasury_QueryMaxRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Rizonworld_Rizon_Treasury_QueryMaxResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// params defines maximum mintable amount of uatolo
  var maxAtoloSupply: Rizonworld_Rizon_Treasury_MaxAtoloSupply {
    get {return _maxAtoloSupply ?? Rizonworld_Rizon_Treasury_MaxAtoloSupply()}
    set {_maxAtoloSupply = newValue}
  }
  /// Returns true if `maxAtoloSupply` has been explicitly set.
  var hasMaxAtoloSupply: Bool {return self._maxAtoloSupply != nil}
  /// Clears the value of `maxAtoloSupply`. Subsequent reads from it will return its default value.
  mutating func clearMaxAtoloSupply() {self._maxAtoloSupply = nil}

  var unknownFields = SwiftProtobuf.UnknownStorage()

  init() {}

  fileprivate var _maxAtoloSupply: Rizonworld_Rizon_Treasury_MaxAtoloSupply? = nil
}
...
extension Rizonworld_Rizon_Treasury_QueryCurrenciesResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularMessageField(value: &self._currencies) }()
...
extension Rizonworld_Rizon_Treasury_QueryMaxRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".QueryMaxRequest"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  static func ==(lhs: Rizonworld_Rizon_Treasury_QueryMaxRequest, rhs: Rizonworld_Rizon_Treasury_QueryMaxRequest) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Rizonworld_Rizon_Treasury_QueryMaxResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".QueryMaxResponse"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "max_atolo_supply"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularMessageField(value: &self._maxAtoloSupply) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if let v = self._maxAtoloSupply {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: Rizonworld_Rizon_Treasury_QueryMaxResponse, rhs: Rizonworld_Rizon_Treasury_QueryMaxResponse) -> Bool {
    if lhs._maxAtoloSupply != rhs._maxAtoloSupply {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
