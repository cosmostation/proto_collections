...
extension Irismod_Oracle_MsgCreateFeed: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularUInt64Field(value: &self.latestHistory) }()
      ...
      case 8: try { try decoder.decodeSingularInt64Field(value: &self.timeout) }()
      case 9: try { try decoder.decodeRepeatedMessageField(value: &self.serviceFeeCap) }()
      case 10: try { try decoder.decodeSingularUInt64Field(value: &self.repeatedFrequency) }()
      case 11: try { try decoder.decodeSingularStringField(value: &self.aggregateFunc) }()
      case 12: try { try decoder.decodeSingularStringField(value: &self.valueJsonPath) }()
      case 13: try { try decoder.decodeSingularUInt32Field(value: &self.responseThreshold) }()
      default: break
      }
    }
  }
...
extension Irismod_Oracle_MsgEditFeed: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularUInt64Field(value: &self.latestHistory) }()
      case 4: try { try decoder.decodeRepeatedStringField(value: &self.providers) }()
