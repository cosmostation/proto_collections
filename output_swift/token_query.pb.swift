...
struct Irismod_Token_QueryTokenResponse {
  ...
  var token: SwiftProtobuf.Google_Protobuf_Any {
    get {return _token ?? SwiftProtobuf.Google_Protobuf_Any()}
    set {_token = newValue}
  }
  ...
  fileprivate var _token: SwiftProtobuf.Google_Protobuf_Any? = nil
}
...
extension Irismod_Token_QueryFeesResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularMessageField(value: &self._issueFee) }()
      case 3: try { try decoder.decodeSingularMessageField(value: &self._mintFee) }()
      default: break
      }
    }
  }
