...
extension Irismod_Token_Params: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularStringField(value: &self.tokenTaxRate) }()
      case 2: try { try decoder.decodeSingularMessageField(value: &self._issueTokenBaseFee) }()
      case 3: try { try decoder.decodeSingularStringField(value: &self.mintTokenFeeRatio) }()
      default: break
      }
    }
  }
