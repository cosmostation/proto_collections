...
// Source: crytoorg_nft/v1/nft.proto
//
...
struct Chainmain_Nft_V1_BaseNFT {
...
struct Chainmain_Nft_V1_IDCollection {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Chainmain_Nft_V1_Owner {
  ...
  var idCollections: [Chainmain_Nft_V1_IDCollection] = []
...
struct Chainmain_Nft_V1_Collection {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var nfts: [Chainmain_Nft_V1_BaseNFT] = []
...
extension Chainmain_Nft_V1_BaseNFT: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Chainmain_Nft_V1_BaseNFT, rhs: Chainmain_Nft_V1_BaseNFT) -> Bool {
...
extension Chainmain_Nft_V1_Denom: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Chainmain_Nft_V1_Denom, rhs: Chainmain_Nft_V1_Denom) -> Bool {
    if lhs.id != rhs.id {return false}
    if lhs.name != rhs.name {return false}
...
extension Chainmain_Nft_V1_IDCollection: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Chainmain_Nft_V1_IDCollection, rhs: Chainmain_Nft_V1_IDCollection) -> Bool {
...
extension Chainmain_Nft_V1_Owner: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Chainmain_Nft_V1_Owner, rhs: Chainmain_Nft_V1_Owner) -> Bool {
...
extension Chainmain_Nft_V1_Collection: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Chainmain_Nft_V1_Collection, rhs: Chainmain_Nft_V1_Collection) -> Bool {
