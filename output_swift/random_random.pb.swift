...
extension Irismod_Random_Random: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularStringField(value: &self.requestTxHash) }()
...
extension Irismod_Random_Request: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try { try decoder.decodeSingularBoolField(value: &self.oracle) }()
      case 5: try { try decoder.decodeRepeatedMessageField(value: &self.serviceFeeCap) }()
      case 6: try { try decoder.decodeSingularStringField(value: &self.serviceContextID) }()
      default: break
      }
    }
  }
