...
extension Irismod_Oracle_Feed: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularStringField(value: &self.aggregateFunc) }()
      case 4: try { try decoder.decodeSingularStringField(value: &self.valueJsonPath) }()
      case 5: try { try decoder.decodeSingularUInt64Field(value: &self.latestHistory) }()
      case 6: try { try decoder.decodeSingularStringField(value: &self.requestContextID) }()
