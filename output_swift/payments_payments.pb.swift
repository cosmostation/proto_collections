...
struct Payments_Subscription {
  ...
  var period: SwiftProtobuf.Google_Protobuf_Any {
    get {return _period ?? SwiftProtobuf.Google_Protobuf_Any()}
  ...
  fileprivate var _period: SwiftProtobuf.Google_Protobuf_Any? = nil
}
