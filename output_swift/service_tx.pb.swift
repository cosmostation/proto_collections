...
extension Irismod_Service_MsgCallService: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularStringField(value: &self.serviceName) }()
      case 2: try { try decoder.decodeRepeatedStringField(value: &self.providers) }()
      case 3: try { try decoder.decodeSingularStringField(value: &self.consumer) }()
      case 4: try { try decoder.decodeSingularStringField(value: &self.input) }()
      case 5: try { try decoder.decodeRepeatedMessageField(value: &self.serviceFeeCap) }()
      case 6: try { try decoder.decodeSingularInt64Field(value: &self.timeout) }()
      case 7: try { try decoder.decodeSingularBoolField(value: &self.repeated) }()
      case 8: try { try decoder.decodeSingularUInt64Field(value: &self.repeatedFrequency) }()
      case 9: try { try decoder.decodeSingularInt64Field(value: &self.repeatedTotal) }()
      default: break
      }
    }
  }
...
extension Irismod_Service_MsgUpdateRequestContext: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeRepeatedStringField(value: &self.providers) }()
      case 3: try { try decoder.decodeSingularStringField(value: &self.consumer) }()
      case 4: try { try decoder.decodeRepeatedMessageField(value: &self.serviceFeeCap) }()
      case 5: try { try decoder.decodeSingularInt64Field(value: &self.timeout) }()
      case 6: try { try decoder.decodeSingularUInt64Field(value: &self.repeatedFrequency) }()
      case 7: try { try decoder.decodeSingularInt64Field(value: &self.repeatedTotal) }()
      default: break
      }
    }
  }
