...
struct Desmos_Profiles_V1beta1_MsgLinkChainAccount {
  ...
  /// linked
  var chainAddress: SwiftProtobuf.Google_Protobuf_Any {
    get {return _chainAddress ?? SwiftProtobuf.Google_Protobuf_Any()}
  ...
  fileprivate var _chainAddress: SwiftProtobuf.Google_Protobuf_Any? = nil
