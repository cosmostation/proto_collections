...
struct Irismod_Service_Params {
  ...
  var restrictedServiceFeeDenom: Bool = false
...
extension Irismod_Service_ServiceDefinition: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 5: try { try decoder.decodeSingularStringField(value: &self.authorDescription) }()
      case 6: try { try decoder.decodeSingularStringField(value: &self.schemas) }()
      default: break
      }
    }
  }
...
extension Irismod_Service_ServiceBinding: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeRepeatedMessageField(value: &self.deposit) }()
      case 4: try { try decoder.decodeSingularStringField(value: &self.pricing) }()
      case 5: try { try decoder.decodeSingularUInt64Field(value: &self.qos) }()
      case 6: try { try decoder.decodeSingularStringField(value: &self.options) }()
      case 7: try { try decoder.decodeSingularBoolField(value: &self.available) }()
      case 8: try { try decoder.decodeSingularMessageField(value: &self._disabledTime) }()
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 2: try { try decoder.decodeRepeatedStringField(value: &_storage._providers) }()
        case 3: try { try decoder.decodeSingularStringField(value: &_storage._consumer) }()
        case 4: try { try decoder.decodeSingularStringField(value: &_storage._input) }()
        case 5: try { try decoder.decodeRepeatedMessageField(value: &_storage._serviceFeeCap) }()
        case 6: try { try decoder.decodeSingularStringField(value: &_storage._moduleName) }()
        case 7: try { try decoder.decodeSingularInt64Field(value: &_storage._timeout) }()
        case 8: try { try decoder.decodeSingularBoolField(value: &_storage._repeated) }()
        case 9: try { try decoder.decodeSingularUInt64Field(value: &_storage._repeatedFrequency) }()
        case 10: try { try decoder.decodeSingularInt64Field(value: &_storage._repeatedTotal) }()
        case 11: try { try decoder.decodeSingularUInt64Field(value: &_storage._batchCounter) }()
        case 12: try { try decoder.decodeSingularUInt32Field(value: &_storage._batchRequestCount) }()
        case 13: try { try decoder.decodeSingularUInt32Field(value: &_storage._batchResponseCount) }()
        case 14: try { try decoder.decodeSingularUInt32Field(value: &_storage._batchResponseThreshold) }()
        case 15: try { try decoder.decodeSingularUInt32Field(value: &_storage._responseThreshold) }()
        case 16: try { try decoder.decodeSingularEnumField(value: &_storage._batchState) }()
...
extension Irismod_Service_Request: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try { try decoder.decodeSingularStringField(value: &self.consumer) }()
      case 5: try { try decoder.decodeSingularStringField(value: &self.input) }()
      case 6: try { try decoder.decodeRepeatedMessageField(value: &self.serviceFee) }()
      case 7: try { try decoder.decodeSingularInt64Field(value: &self.requestHeight) }()
      case 8: try { try decoder.decodeSingularInt64Field(value: &self.expirationHeight) }()
      case 9: try { try decoder.decodeSingularStringField(value: &self.requestContextID) }()
      case 10: try { try decoder.decodeSingularUInt64Field(value: &self.requestContextBatchCounter) }()
      default: break
      }
    }
  }
...
extension Irismod_Service_CompactRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularStringField(value: &self.requestContextID) }()
      case 2: try { try decoder.decodeSingularUInt64Field(value: &self.requestContextBatchCounter) }()
      case 3: try { try decoder.decodeSingularStringField(value: &self.provider) }()
      case 4: try { try decoder.decodeRepeatedMessageField(value: &self.serviceFee) }()
      case 5: try { try decoder.decodeSingularInt64Field(value: &self.requestHeight) }()
      case 6: try { try decoder.decodeSingularInt64Field(value: &self.expirationHeight) }()
      default: break
      }
    }
  }
...
extension Irismod_Service_Response: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 5: try { try decoder.decodeSingularStringField(value: &self.requestContextID) }()
      case 6: try { try decoder.decodeSingularUInt64Field(value: &self.requestContextBatchCounter) }()
      default: break
      }
    }
  }
...
extension Irismod_Service_Pricing: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 2: try { try decoder.decodeRepeatedMessageField(value: &self.promotionsByTime) }()
      case 3: try { try decoder.decodeRepeatedMessageField(value: &self.promotionsByVolume) }()
...
extension Irismod_Service_PromotionByTime: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularStringField(value: &self.discount) }()
      default: break
      }
    }
  }
...
extension Irismod_Service_PromotionByVolume: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularUInt64Field(value: &self.volume) }()
      case 2: try { try decoder.decodeSingularStringField(value: &self.discount) }()
      default: break
      }
    }
  }
...
extension Irismod_Service_Params: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    10: .standard(proto: "restricted_service_fee_denom"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularInt64Field(value: &self.maxRequestTimeout) }()
      case 2: try { try decoder.decodeSingularInt64Field(value: &self.minDepositMultiple) }()
      case 3: try { try decoder.decodeRepeatedMessageField(value: &self.minDeposit) }()
      case 4: try { try decoder.decodeSingularStringField(value: &self.serviceFeeTax) }()
      case 5: try { try decoder.decodeSingularStringField(value: &self.slashFraction) }()
      case 6: try { try decoder.decodeSingularMessageField(value: &self._complaintRetrospect) }()
      case 7: try { try decoder.decodeSingularMessageField(value: &self._arbitrationTimeLimit) }()
      case 8: try { try decoder.decodeSingularUInt64Field(value: &self.txSizeLimit) }()
      case 9: try { try decoder.decodeSingularStringField(value: &self.baseDenom) }()
      case 10: try { try decoder.decodeSingularBoolField(value: &self.restrictedServiceFeeDenom) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.restrictedServiceFeeDenom != false {
      try visitor.visitSingularBoolField(value: self.restrictedServiceFeeDenom, fieldNumber: 10)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  static func ==(lhs: Irismod_Service_Params, rhs: Irismod_Service_Params) -> Bool {
    ...
    if lhs.restrictedServiceFeeDenom != rhs.restrictedServiceFeeDenom {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
