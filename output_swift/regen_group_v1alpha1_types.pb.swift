...
enum Regen_Group_V1alpha1_Choice: SwiftProtobuf.Enum {
...
extension Regen_Group_V1alpha1_Choice: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [Regen_Group_V1alpha1_Choice] = [
    .unspecified,
    .no,
    .yes,
    .abstain,
...
struct Regen_Group_V1alpha1_Member {
...
struct Regen_Group_V1alpha1_Members {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Regen_Group_V1alpha1_ThresholdDecisionPolicy {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Regen_Group_V1alpha1_GroupInfo {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Regen_Group_V1alpha1_GroupMember {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var member: Regen_Group_V1alpha1_Member {
    get {return _member ?? Regen_Group_V1alpha1_Member()}
  ...
  fileprivate var _member: Regen_Group_V1alpha1_Member? = nil
}

/// GroupAccountInfo represents the high-level on-chain information for a group account.
struct Regen_Group_V1alpha1_GroupAccountInfo {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Regen_Group_V1alpha1_Proposal {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var status: Regen_Group_V1alpha1_Proposal.Status {
  ...
  var result: Regen_Group_V1alpha1_Proposal.Result {
    get {return _storage._result}
    set {_uniqueStorage()._result = newValue}
  }

  /// vote_state contains the sums of all weighted votes for this proposal.
  var voteState: Regen_Group_V1alpha1_Tally {
    get {return _storage._voteState ?? Regen_Group_V1alpha1_Tally()}
  ...
  var executorResult: Regen_Group_V1alpha1_Proposal.ExecutorResult {
...
extension Regen_Group_V1alpha1_Proposal.Status: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [Regen_Group_V1alpha1_Proposal.Status] = [
    .unspecified,
    .submitted,
    .closed,
    .aborted,
...
extension Regen_Group_V1alpha1_Proposal.Result: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [Regen_Group_V1alpha1_Proposal.Result] = [
    .unspecified,
    .unfinalized,
    .accepted,
    .rejected,
...
extension Regen_Group_V1alpha1_Proposal.ExecutorResult: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [Regen_Group_V1alpha1_Proposal.ExecutorResult] = [
    .unspecified,
    .notRun,
    .success,
    .failure,
...
struct Regen_Group_V1alpha1_Tally {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Regen_Group_V1alpha1_Vote {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Regen_Group_V1alpha1_Choice: SwiftProtobuf._ProtoNameProviding {
...
extension Regen_Group_V1alpha1_Member: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Regen_Group_V1alpha1_Member, rhs: Regen_Group_V1alpha1_Member) -> Bool {
...
extension Regen_Group_V1alpha1_Members: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Regen_Group_V1alpha1_Members, rhs: Regen_Group_V1alpha1_Members) -> Bool {
...
extension Regen_Group_V1alpha1_ThresholdDecisionPolicy: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Regen_Group_V1alpha1_ThresholdDecisionPolicy, rhs: Regen_Group_V1alpha1_ThresholdDecisionPolicy) -> Bool {
...
extension Regen_Group_V1alpha1_GroupInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Regen_Group_V1alpha1_GroupInfo, rhs: Regen_Group_V1alpha1_GroupInfo) -> Bool {
...
extension Regen_Group_V1alpha1_GroupMember: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Regen_Group_V1alpha1_GroupMember, rhs: Regen_Group_V1alpha1_GroupMember) -> Bool {
    if lhs.groupID != rhs.groupID {return false}
...
extension Regen_Group_V1alpha1_GroupAccountInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Regen_Group_V1alpha1_GroupAccountInfo, rhs: Regen_Group_V1alpha1_GroupAccountInfo) -> Bool {
    if lhs.address != rhs.address {return false}
    if lhs.groupID != rhs.groupID {return false}
    if lhs.admin != rhs.admin {return false}
    if lhs.metadata != rhs.metadata {return false}
...
extension Regen_Group_V1alpha1_Proposal: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _status: Regen_Group_V1alpha1_Proposal.Status = .unspecified
    var _result: Regen_Group_V1alpha1_Proposal.Result = .unspecified
    var _voteState: Regen_Group_V1alpha1_Tally? = nil
    var _timeout: SwiftProtobuf.Google_Protobuf_Timestamp? = nil
    var _executorResult: Regen_Group_V1alpha1_Proposal.ExecutorResult = .unspecified
  ...
  static func ==(lhs: Regen_Group_V1alpha1_Proposal, rhs: Regen_Group_V1alpha1_Proposal) -> Bool {
...
extension Regen_Group_V1alpha1_Proposal.Status: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Regen_Group_V1alpha1_Proposal.Result: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Regen_Group_V1alpha1_Proposal.ExecutorResult: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Regen_Group_V1alpha1_Tally: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Regen_Group_V1alpha1_Tally, rhs: Regen_Group_V1alpha1_Tally) -> Bool {
...
extension Regen_Group_V1alpha1_Vote: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Regen_Group_V1alpha1_Vote, rhs: Regen_Group_V1alpha1_Vote) -> Bool {
