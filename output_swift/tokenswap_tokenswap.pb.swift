...
struct Rizonworld_Rizon_Tokenswap_SwappedAmount {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Rizonworld_Rizon_Tokenswap_SwappedAmount: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".SwappedAmount"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "amount"),
  ]
  ...
  static func ==(lhs: Rizonworld_Rizon_Tokenswap_SwappedAmount, rhs: Rizonworld_Rizon_Tokenswap_SwappedAmount) -> Bool {
    if lhs.amount != rhs.amount {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
