...
struct Osmosis_Gamm_Poolmodels_Stableswap_V1beta1_Pool {
  ...
  var scalingFactorGovernor: String = String()
...
extension Osmosis_Gamm_Poolmodels_Stableswap_V1beta1_Pool: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    8: .standard(proto: "scaling_factor_governor"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 8: try { try decoder.decodeSingularStringField(value: &self.scalingFactorGovernor) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.scalingFactorGovernor.isEmpty {
      try visitor.visitSingularStringField(value: self.scalingFactorGovernor, fieldNumber: 8)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  static func ==(lhs: Osmosis_Gamm_Poolmodels_Stableswap_V1beta1_Pool, rhs: Osmosis_Gamm_Poolmodels_Stableswap_V1beta1_Pool) -> Bool {
    ...
    if lhs.scalingFactorGovernor != rhs.scalingFactorGovernor {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
