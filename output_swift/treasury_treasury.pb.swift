...
struct Rizonworld_Rizon_Treasury_MaxAtoloSupply {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Rizonworld_Rizon_Treasury_MaxAtoloSupply: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".MaxAtoloSupply"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "amount"),
  ]
  ...
  static func ==(lhs: Rizonworld_Rizon_Treasury_MaxAtoloSupply, rhs: Rizonworld_Rizon_Treasury_MaxAtoloSupply) -> Bool {
